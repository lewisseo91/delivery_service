...
public class JwtTokenProvider {
    ...
    public static final String TEST_SECRET = "ZGVmYXVsdCBrZXkgZm9yIHRlc3QgbGV3aXMgc2VvIDIwMjMgMDUgMjAgZGZzbGFrZmRzYWxramZkc2Fsa2pmZHNhbGtmanM=";
    ...
    public JwtTokenProvider() {
        this.secret = null;
        this.tokenValidityInMilliseconds = 0L;
