...
public class OrderUpdateAddressResponse {
    ...
    @Builder
    public OrderUpdateAddressResponse(Long id, String orderId, String orderUserId, String orderAddress, String orderStoreId, String orderMoverId, Boolean orderStarted, LocalDateTime orderCreatedAt) {
        this.id = id;
    ...
    public static OrderUpdateAddressResponse of(Order order) {
        return OrderUpdateAddressResponse.builder()
                .id(order.getId())
