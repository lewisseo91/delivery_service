...
public class OrderAddResponse {
    ...
    @Builder
    public OrderAddResponse(Long id, String orderId, String orderUserId, String orderAddress, String orderStoreId, String orderMoverId, Boolean orderStarted, LocalDateTime orderCreatedAt) {
        this.id = id;
    ...
    public static OrderAddResponse of(Order order) {
